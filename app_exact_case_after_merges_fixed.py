...
def main():
    ...
    # Final safety pass: merge exact same brands written with different casing.
    # This must run after rule-based and exact merges too, otherwise values like
    # "Stihl" and "STIHL" can remain as separate bars.
    if hasattr(backend_mod, "auto_merge_exact_case"):
        mentions_for_analysis["brand"] = backend_mod.auto_merge_exact_case(mentions_for_analysis["brand"])

...
def _contains_brand_token(s: str, token: str) -> bool:
    return _compact_brand_token(token) in _compact_brand_token(s)
...
def suggest_brand_merges(
    ...
    forced_merge_rules = [
        ...
        (lambda b: _contains_brand_token(b, "Landorid"), "Worx", "forced landorid -> Worx"),
        (lambda b: _contains_brand_token(b, "LUBA"), "Mammotion", "forced LUBA -> Mammotion"),
        (lambda b: _contains_brand_token(b, "Yuka"), "Mammotion", "forced Yuka -> Mammotion"),
        (lambda b: _contains_brand_token(b, "Navimow"), "Segway", "forced Navimow -> Segway"),
        (lambda b: _contains_brand_token(b, "iMOW"), "STIHL", "forced iMOW -> STIHL"),
        (lambda b: _contains_brand_token(b, "EasiLife"), "Flymo", "forced EasiLife -> Flymo"),
        (lambda b: _contains_brand_token(b, "UltraLife"), "Flymo", "forced UltraLife -> Flymo"),
    ]

...
def normalize_url_for_count(url: str) -> str:
    """Normalize a URL for counting citations.

    - Remove utm_* query parameters (case-insensitive)
    - Remove fragments (#...)
    - Normalize scheme to https
    - Lowercase hostname and strip leading www.
    - Remove trailing slash for non-root paths
    - Preserve non-UTM query parameters (sorted) so different URLs stay distinct
    """

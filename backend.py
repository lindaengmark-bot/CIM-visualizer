...
# ============================================================
# Brand Similarity Engine (unique canonical + casing control)
# ============================================================

from difflib import SequenceMatcher

def _canonical_case(s: str) -> str:
    """Förslagets standardformat: Första bokstaven versal, resten gemener."""
...
def suggest_brand_merges(
    ...
    """Bygger förslag med EN unik canonical per kluster."""
        ...
        for i in range(L):
            for j in range(i + 1, L):
                ...
                if norm_exact.get(a, "") and norm_exact[a] == norm_exact.get(b, ""):
                    uf.union(a, b)
                    _record_edge(a, b, "exact (case-insensitive)", 1.0)
                    continue
